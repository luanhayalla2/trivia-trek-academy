...
import { Calculator, BookOpen, Atom, Clock, Globe, Palette, Languages, Code, Music, Dumbbell, Brain, Users, Microscope, Zap, Leaf, Heart, DollarSign, Scale, Building, Hammer, PenTool, Star, Mountain, TrendingUp, TreePine, Activity, Briefcase, Stethoscope, Wrench, Camera, Gamepad2, Plane } from "lucide-react";
